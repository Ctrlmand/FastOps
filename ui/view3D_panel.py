import bpy
from ..operators import mesh, object, object_rename

# Rename Panel 
class FASTOPS_UI_PT_Object(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        row = layout.row()
        row.operator(object.F_OT_ObjMoveToCollectionByName.bl_idname, text="Group it!")

# Edit Normal Panel
class FASTOPS_UI_PT_Mesh(bpy.types.Panel):
    bl_space_type = "VIEW_3D"
    bl_region_type = "UI"
    bl_category = "FastOps"
    bl_label = "Mesh"
